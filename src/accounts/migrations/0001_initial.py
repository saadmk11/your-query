# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-02 20:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, default='default.png', height_field='height_field', null=True, upload_to=b'', verbose_name='profile picture', width_field='width_field')),
                ('height_field', models.IntegerField(blank=True, default=600, null=True)),
                ('width_field', models.IntegerField(blank=True, default=600, null=True)),
